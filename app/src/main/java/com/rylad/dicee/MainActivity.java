    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rollButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d("Dicee", "left: " + leftNumber + " right:" + rightNumber);
                leftDice.setImageResource(diceArray[leftNumber-1]);
                rightDice.setImageResource(diceArray[rightNumber-1]);
            }
        });
    }
}
